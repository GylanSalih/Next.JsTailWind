...
const Carousel = () => {
  ...
  const slides = [
    { id: 1, img: '/assets/img/reduced_images/nature-img.png', subtitle: 'Gylan Salih', description: 'Explore my journey through code and creativity. Here, I showcase my projects, each project made with passion, dedication & Love.' },
    { id: 2, img: '/assets/img/reduced_images/redsword-img.png', subtitle: 'Gylan Salih', description: 'Explore my journey through code and creativity. Here, I showcase my projects, each project made with passion, dedication & Love.' },
    { id: 3, img: '/assets/img/reduced_images/5.jpeg', subtitle: 'Gylan Salih', description: 'Explore my journey through code and creativity. Here, I showcase my projects, each project made with passion, dedication & Love.' },
    { id: 4, img: '/assets/img/reduced_images/7.jpg', subtitle: 'Gylan Salih', description: 'Explore my journey through code and creativity. Here, I showcase my projects, each project made with passion, dedication & Love.' },
    { id: 5, img: '/assets/img/reduced_images/6.jpg', subtitle: 'Gylan Salih', description: 'Explore my journey through code and creativity. Here, I showcase my projects, each project made with passion, dedication & Love.' },
  ];
